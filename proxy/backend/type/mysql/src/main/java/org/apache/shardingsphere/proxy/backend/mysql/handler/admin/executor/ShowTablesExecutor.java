...
public final class ShowTablesExecutor implements DatabaseAdminQueryExecutor {
    ...
    public void execute(final ConnectionSession connectionSession) {
        ...
        System.out.println("********execute databaseName: " + databaseName);
    ...
    private QueryResultMetaData createQueryResultMetaData(final String databaseName) {
        System.out.println("********createQueryResultMetaData databaseName: " + databaseName);
        ...
        System.out.println("********createQueryResultMetaData tableColumnName: " + tableColumnName);
        ...
        System.out.println("********createQueryResultMetaData columnNames: " + columnNames.stream().map(RawQueryResultColumnMetaData::getTableName).collect(Collectors.toList()));
        return new RawQueryResultMetaData(columnNames);
    }

    private QueryResult getQueryResult(final String databaseName) {
        System.out.println("********getQueryResult databaseName: " + databaseName);
    ...
    private MemoryQueryResultDataRow getRow(final ShardingSphereTable table) {
        System.out.println("********getRow table: " + table.getName());
    ...
    private Collection<ShardingSphereTable> getTables(final String databaseName) {
        System.out.println("********getTables databaseName: " + databaseName);
    ...
    private Collection<ShardingSphereTable> filterByLike(final Collection<ShardingSphereTable> tables) {
        System.out.println("********filterByLike tables size: " + tables.size());
        System.out.println("********filterByLike tables: " + tables.stream().map(ShardingSphereTable::getName).collect(Collectors.toList()));
